...
=========
Timer System:
- 60-minute countdown timer displayed as MM:SS (60:00 → 00:00)
- Pause button - temporarily stop the timer
- Resume button - continue after pause
- Stop button - permanently stop the timer
- Color-coded display: Green (>10min) → Orange (≤10min) → Red (≤5min)
- 5-minute warning dialog that must be acknowledged
- Auto-submit and grade when timer reaches 00:00

Question Features:
- 65 questions randomly selected from 100-question bank
- Single-select questions (radio buttons)
- Multi-select questions (checkboxes) - clearly marked
...
- Detailed breakdown by all 8 exam domains
...
class Question:
    """Represents a single exam question with support for single and multi-select answers"""
...
class SplunkPracticeExam:
    """Main application class for the Splunk Core User Practice Exam"""
    
    def __init__(self, root: tk.Tk):
        self.root = root
        self.root.title("Splunk Core User Certification - Practice Exam")
        ...
        # Load questions and select 65 randomly
        ...
        # Timer configuration (60 minutes = 3600 seconds)
    ...
    def setup_styles(self):
        ...
        style.configure('TimerGreen.TLabel', font=('Arial', 18, 'bold'), foreground='#228B22')
        style.configure('TimerOrange.TLabel', font=('Arial', 18, 'bold'), foreground='#FF8C00')
        style.configure('TimerRed.TLabel', font=('Arial', 18, 'bold'), foreground='#DC143C')
    
    def select_exam_questions(self, all_questions: List[Question], count: int) -> List[Question]:
        """Select questions maintaining domain distribution based on exam blueprint"""
        ...
        # Domain weights based on official exam blueprint
        domain_weights = {
            "Domain 1.0": 0.05,
            "Domain 2.0": 0.22,
            "Domain 3.0": 0.20,
    ...
    def load_all_questions(self) -> List[Question]:
        ...
        question_data = [
            ...
            (9, "Domain 2.0: Basic Searching (22%)",
             ...
             ["A", "B", "C"],
             "The @ symbol snaps/rounds time to specified units: @d (day), @h (hour), @m (minute), @mon (month), @w (week).",
             True),
            ...
            (11, "Domain 2.0: Basic Searching (22%)",
             ...
             ["C"],
             "Verbose mode discovers all possible fields but is slower. Fast mode extracts minimal fields. Smart mode balances both.",
             False),
            ...
            (12, "Domain 2.0: Basic Searching (22%)",
             ...
             {"A": "fieldname=*", 
              ...
              "D": "fieldname!=*"},
             ["B", "C"],
             'fieldname="" finds events with empty values. Combined with isnotnull() finds fields that exist but are empty.',
             True),
            ...
            (17, "Domain 2.0: Basic Searching (22%)",
             ...
             ["C"],
             "The outputcsv command writes search results to a CSV file for future use.",
             False),
            ...
            (18, "Domain 2.0: Basic Searching (22%)",
             ...
             {"A": "error | warning", 
              ...
              "D": "(error, warning)"},
             ["B"],
             "Use the OR operator: error OR warning.",
             False),
            ...
            (19, "Domain 2.0: Basic Searching (22%)",
             ...
             ["A"],
             "index=* is a wildcard that searches across all available indexes.",
             False),
            ...
            (20, "Domain 2.0: Basic Searching (22%)",
             ...
             ["A", "B", "C"],
             "Options A, B, and C use valid time modifiers. 'today' and 'tomorrow' are not valid syntax.",
             True),
            ...
            (21, "Domain 2.0: Basic Searching (22%)",
             ...
             ["A"],
             "The Job Inspector provides detailed information about search execution and optimization.",
             False),
            ...
            (22, "Domain 2.0: Basic Searching (22%)",
             ...
             ["B"],
             "The _time field contains the timestamp of when the event actually occurred.",
             False),
            ...
            (24, "Domain 2.0: Basic Searching (22%)",
             ...
             ["C"],
             "By default, search job results are retained for 7 days.",
             False),
            ...
            (25, "Domain 2.0: Basic Searching (22%)",
             ...
             {"A": '" (double quote)', 
              ...
              "D": "= (equals)"},
             ["A", "B"],
             "Double quotes and backslashes require escaping. Asterisks are wildcards, equals are operators.",
             True),
            ...
            (26, "Domain 2.0: Basic Searching (22%)",
             ...
             ["B"],
             "Specify a narrow time window using earliest and latest with specific timestamps.",
             False),
            ...
            (27, "Domain 2.0: Basic Searching (22%)",
             ...
             ["B"],
             "'Send to Background' moves the search to the background so you can navigate away.",
             False),
            ...
            (29, "Domain 3.0: Using Fields in Searches (20%)",
             ...
             ["B"],
             "Fields appearing in 20% or more of events are automatically classified as 'Interesting Fields'.",
             False),
            ...
            (30, "Domain 3.0: Using Fields in Searches (20%)",
             ...
             {"A": "Automatic extraction (default)", 
              ...
              "E": "JSON parsing"},
             ["A", "B", "C", "D", "E"],
             "Splunk uses all listed extraction methods.",
             True),
            ...
            (31, "Domain 3.0: Using Fields in Searches (20%)",
             ...
             ["A"],
             "For numeric comparisons at search time, use: response_time>1000.",
             False),
            
            (32, "Domain 3.0: Using Fields in Searches (20%)",
             "Which command would you use to exclude multiple fields from search results?",
             {"A": "fields - fieldname1, fieldname2", 
              "B": "fields - fieldname1 - fieldname2", 
              "C": "table * - fieldname1 - fieldname2", 
              "D": "remove fieldname1, fieldname2"},
             ["A"],
             "The correct syntax is 'fields - field1, field2' with comma-separated list.",
             False),
            ...
            (33, "Domain 3.0: Using Fields in Searches (20%)",
             ...
             ["A"],
             "host identifies the machine; source identifies the specific file or input.",
             False),
            ...
            (34, "Domain 3.0: Using Fields in Searches (20%)",
             ...
             ["A"],
             "Field names are case-sensitive (Status ≠ status), but field values are not by default.",
             False),
            ...
            (36, "Domain 3.0: Using Fields in Searches (20%)",
             ...
             {"A": "NOT fieldname=*", 
              ...
              "D": "fieldname!=*"},
             ["A"],
             "NOT fieldname=* finds events where the field does not exist.",
             False),
            ...
            (37, "Domain 3.0: Using Fields in Searches (20%)",
             ...
             {"A": "The original, unparsed event text", 
              ...
              "D": "The timestamp"},
             ["A"],
             "_raw contains the complete original event text before any parsing.",
             False),
            ...
            (38, "Domain 3.0: Using Fields in Searches (20%)",
             ...
             ["A"],
             "Use the wildcard * after the prefix: user=admin*.",
             False),
            ...
            (41, "Domain 3.0: Using Fields in Searches (20%)",
             ...
             ["A", "B"],
             "_time and _raw are internal metadata fields (prefixed with underscore).",
             True),
            ...
            (42, "Domain 3.0: Using Fields in Searches (20%)",
             ...
             ["B"],
             "Field aliases create alternate names without changing the original field.",
             False),
            ...
            (43, "Domain 3.0: Using Fields in Searches (20%)",
             ...
             {"A": 'status="" OR status=200', 
              ...
              "D": "Both A and C"},
             ["D"],
             "Both direct field comparison and where command work.",
             False),
            ...
            (44, "Domain 3.0: Using Fields in Searches (20%)",
             ...
             ["B"],
             "The eval command creates new fields or modifies existing ones using expressions.",
             False),
            ...
            (47, "Domain 3.0: Using Fields in Searches (20%)",
             ...
             ["B"],
             "fields includes/excludes fields from processing. table formats output as a table.",
             False),
            ...
            (48, "Domain 4.0: Search Language Fundamentals (15%)",
             ...
             ["B"],
             "The dedup command removes duplicate events: dedup user.",
             False),
            ...
            (49, "Domain 4.0: Search Language Fundamentals (15%)",
             ...
             ["A", "D"],
             "Valid: multiple renames in one command with 'as', or chained commands with pipe.",
             True),
            ...
            (51, "Domain 4.0: Search Language Fundamentals (15%)",
             ...
             ["B"],
             "The pipe symbol chains commands, passing results from one command to the next.",
             False),
            ...
            (52, "Domain 4.0: Search Language Fundamentals (15%)",
             ...
             {"A": "index=web AND sourcetype=access_combined", 
              ...
              "D": "Both A and B"},
             ["D"],
             "Both explicit AND and implicit AND (space) work.",
             False),
            ...
            (53, "Domain 4.0: Search Language Fundamentals (15%)",
             ...
             ["A", "B", "C", "D"],
             "Transforming commands: stats, top, rare, chart. fields and rename are non-transforming.",
             True),
            ...
            (57, "Domain 4.0: Search Language Fundamentals (15%)",
             ...
             ["B"],
             "The eval command creates new fields using expressions.",
             False),
            ...
            (58, "Domain 4.0: Search Language Fundamentals (15%)",
             ...
             ["A"],
             "The where command filters results based on eval expressions.",
             False),
            ...
            (59, "Domain 4.0: Search Language Fundamentals (15%)",
             ...
             ["B"],
             "The tail command returns the last N results: tail 15.",
             False),
            
            (60, "Domain 4.0: Search Language Fundamentals (15%)",
             "Which command can you use to return results in reverse time order?",
             {"A": "reverse", "B": "sort -_time", "C": "order desc", "D": "tail"},
             ["B"],
             "sort -_time sorts results by time in descending order.",
             False),
            ...
            (61, "Domain 4.0: Search Language Fundamentals (15%)",
             ...
             ["B"],
             "rename changes only the name. eval can create new fields with transformed values.",
             False),
            
            (62, "Domain 4.0: Search Language Fundamentals (15%)",
             "Which command retrieves the first field value encountered for each unique combination?",
             {"A": "first", "B": "head", "C": "stats first()", "D": "initial"},
             ["C"],
             "The stats first(fieldname) function returns the first value for each group.",
             False),
            ...
            (63, "Domain 5.0: Using Basic Transforming Commands (15%)",
             ...
             ["A", "B", "C", "D", "E", "F"],
             "All listed functions work with numeric fields.",
             True),
            ...
            (64, "Domain 5.0: Using Basic Transforming Commands (15%)",
             ...
             ["A"],
             "Use comma-separated fields after 'by': stats count by status, host.",
             False),
            ...
            (65, "Domain 5.0: Using Basic Transforming Commands (15%)",
             ...
             {"A": "Returns top 5 results", 
              ...
              "D": "Returns all results sorted descending"},
             ["B"],
             "By default, top returns the 10 most common values with count and percentage.",
             False),
            ...
            (66, "Domain 5.0: Using Basic Transforming Commands (15%)",
             ...
             ["A"],
             "Specify a custom limit: top limit=20 fieldname.",
             False),
            ...
            (68, "Domain 5.0: Using Basic Transforming Commands (15%)",
             ...
             ["A", "B", "C", "D"],
             "values() returns unique sorted values. list() returns all values including duplicates in order.",
             True),
            ...
            (70, "Domain 5.0: Using Basic Transforming Commands (15%)",
             ...
             {"A": "The most common values", 
              ...
              "D": "Deleted events"},
             ["B"],
             "The rare command shows the least frequently occurring values.",
             False),
            ...
            (71, "Domain 5.0: Using Basic Transforming Commands (15%)",
             ...
             ["D"],
             "timechart, chart, and stats by _time can all create time-based charts.",
             False),
            ...
            (72, "Domain 5.0: Using Basic Transforming Commands (15%)",
             ...
             {"A": "stats earliest(_time), latest(_time)", 
              ...
              "D": "Both A and B"},
             ["D"],
             "Both earliest/latest and min/max work for time boundaries.",
             False),
            ...
            (73, "Domain 5.0: Using Basic Transforming Commands (15%)",
             ...
             ["B"],
             "This sums bytes grouped by host, aliasing the result as total_bytes.",
             False),
            ...
            (74, "Domain 5.0: Using Basic Transforming Commands (15%)",
             ...
             ["A", "B", "C", "D", "E", "F"],
             "All listed functions aggregate over multiple events.",
             True),
            ...
            (75, "Domain 5.0: Using Basic Transforming Commands (15%)",
             ...
             {"A": "stats count by status | eval percent=count/total*100", 
              ...
              "D": "Both A and B"},
             ["D"],
             "Calculate with eval after stats, or use top which includes percentages.",
             False),
            ...
            (76, "Domain 5.0: Using Basic Transforming Commands (15%)",
             ...
             {"A": "Counts events by status and sorts by status name", 
              ...
              "D": "Invalid syntax"},
             ["B"],
             "Counts by status, then sorts by count descending (most to least).",
             False),
            ...
            (77, "Domain 5.0: Using Basic Transforming Commands (15%)",
             ...
             ["D"],
             "The bin command (also called bucket) creates groups based on numeric ranges.",
             False),
            ...
            (78, "Domain 6.0: Creating Reports and Dashboards (12%)",
             ...
             ["A", "B", "C", "D", "E"],
             "Reports include search query, time range, visualization, permissions, and scheduling.",
             True),
            ...
            (79, "Domain 6.0: Creating Reports and Dashboards (12%)",
             ...
             ["A", "B", "D"],
             "Line, Area, and Column charts effectively display time-series data.",
             True),
            ...
            (80, "Domain 6.0: Creating Reports and Dashboards (12%)",
             ...
             ["B"],
             "'Shared in App' makes the dashboard available to all users with app access.",
             False),
            ...
            (81, "Domain 6.0: Creating Reports and Dashboards (12%)",
             ...
             {"A": "Raw events", 
              ...
              "D": "A dashboard"},
             ["B"],
             "Visualizations require data from transforming commands like stats, chart, or timechart.",
             False),
            ...
            (82, "Domain 6.0: Creating Reports and Dashboards (12%)",
             ...
             ["A"],
             "Choropleth maps display geographic data by shading regions.",
             False),
            ...
            (83, "Domain 6.0: Creating Reports and Dashboards (12%)",
             ...
             ["B"],
             "Reports can be saved and added as panels to multiple dashboards.",
             False),
            ...
            (84, "Domain 6.0: Creating Reports and Dashboards (12%)",
             ...
             ["A"],
             "Editing a saved report automatically updates all dashboard panels using it.",
             False),
            ...
            (85, "Domain 6.0: Creating Reports and Dashboards (12%)",
             ...
             ["A", "B", "C", "D", "E"],
             "Dashboard panels support all listed content types.",
             True),
            ...
            (86, "Domain 6.0: Creating Reports and Dashboards (12%)",
             ...
             ["B"],
             "Tokens enable dynamic content based on user input selections.",
             False),
            ...
            (87, "Domain 6.0: Creating Reports and Dashboards (12%)",
             ...
             ["A"],
             "Drilldowns are configured in panel settings.",
             False),
            ...
            (88, "Domain 6.0: Creating Reports and Dashboards (12%)",
             ...
             ["B"],
             "Dashboards are defined in XML format.",
             False),
            ...
            (89, "Domain 6.0: Creating Reports and Dashboards (12%)",
             ...
             ["B"],
             "Forms are dashboards with input elements like dropdowns and text boxes.",
             False),
            ...
            (90, "Domain 7.0: Creating and Using Lookups (6%)",
             ...
             ["B"],
             "Lookups add fields from external files to events based on matching values.",
             False),
            ...
            (91, "Domain 7.0: Creating and Using Lookups (6%)",
             ...
             ["A", "B", "C"],
             "Valid commands: lookup, inputlookup, outputlookup.",
             True),
            ...
            (92, "Domain 7.0: Creating and Using Lookups (6%)",
             ...
             ["A", "B", "C"],
             "Automatic lookups require uploading, defining, and configuring automatic settings.",
             True),
            ...
            (93, "Domain 7.0: Creating and Using Lookups (6%)",
             ...
             {"A": "A time field", 
              ...
              "D": "A source field"},
             ["B"],
             "Lookups require a common field to match events with lookup table rows.",
             False),
            ...
            (94, "Domain 7.0: Creating and Using Lookups (6%)",
             ...
             ["A"],
             "Use | inputlookup tablename to view lookup table contents.",
             False),
            ...
            (96, "Domain 8.0: Creating Scheduled Reports and Alerts (5%)",
             ...
             {"A": "Number of results", 
              ...
              "E": "Time of day"},
             ["A", "B", "C", "D"],
             "Valid triggers: number of results, hosts, sources, and custom conditions.",
             True),
            ...
            (97, "Domain 8.0: Creating Scheduled Reports and Alerts (5%)",
             ...
             ["A"],
             "Real-time alerts monitor continuously. Scheduled alerts run at specified times.",
             False),
            ...
            (98, "Domain 8.0: Creating Scheduled Reports and Alerts (5%)",
             ...
             {"A": "Send email", 
              ...
              "F": "Log event"},
             ["A", "B", "C", "D", "F"],
             "Valid actions: send email, run script, webhook, triggered alerts, log event.",
             True),
            ...
            (99, "Domain 8.0: Creating Scheduled Reports and Alerts (5%)",
             ...
             {"A": "Set throttling options", 
              ...
              "D": "All of the above"},
             ["D"],
             "All options help prevent frequent triggering.",
             False),
            ...
            (100, "Domain 8.0: Creating Scheduled Reports and Alerts (5%)",
             ...
             {"A": "Activity > Triggered Alerts", 
              ...
              "D": "Search > Alert Log"},
             ["A"],
             "View alert history at Activity > Triggered Alerts.",
             False),
        ]
    ...
    def stop_timer(self):
        ...
        self.timer_label.config(text=f"⏹ STOPPED - {self.format_time(self.remaining_seconds)}")
    ...
    def update_timer(self):
        ...
        if self.remaining_seconds <= 300:
            self.timer_label.config(style='TimerRed.TLabel')
        elif self.remaining_seconds <= 600:
            self.timer_label.config(style='TimerOrange.TLabel')
        else:
            self.timer_label.config(style='TimerGreen.TLabel')
        ...
        if self.remaining_seconds == 300 and not self.five_minute_warning_shown:
            ...
            messagebox.showwarning(
                ...
                "• The exam will auto-submit at 00:00\n\n"
        ...
        if self.remaining_seconds <= 0:
            self.stop_timer()
            self.timer_label.config(text="⏱ 00:00 - TIME'S UP!")
            
            messagebox.showwarning(
                "⏰ TIME EXPIRED!",
                "Your exam time has expired!\n\n"
                "The exam will now be graded.",
                parent=self.root
            )
    ...
    def setup_ui(self):
        ...
        self.domain_label.grid(row=1, column=0, sticky=tk.W, pady=(5, 5))
        
        self.create_question_frame(main_frame)
        self.create_options_frame(main_frame)
        self.create_explanation_frame(main_frame)
        self.create_navigation_frame(main_frame)
    
    def create_header(self, parent):
        """Create header with title, timer, and progress"""
        header_frame = ttk.Frame(parent)
        header_frame.grid(row=0, column=0, sticky=(tk.W, tk.E), pady=(0, 10))
        header_frame.columnconfigure(0, weight=1)
        
        title = ttk.Label(header_frame, 
                         text="🎓 Splunk Core User Certification Practice Exam",
                         style='Title.TLabel')
        title.grid(row=0, column=0, pady=(0, 10))
        
        timer_frame = ttk.LabelFrame(header_frame, text="⏱ Exam Timer", padding="10")
        timer_frame.grid(row=1, column=0, pady=(0, 10))
        
        self.timer_label = ttk.Label(timer_frame, text="⏱ 60:00", style='TimerGreen.TLabel')
        self.timer_label.grid(row=0, column=0, padx=20)
        
        self.pause_button = ttk.Button(timer_frame, text="⏸ Pause", 
                                       command=self.toggle_pause, width=12)
        self.pause_button.grid(row=0, column=1, padx=5)
        
        self.stop_button = ttk.Button(timer_frame, text="⏹ Stop", 
                                      command=self.stop_timer, width=12)
    ...
    def create_question_frame(self, parent):
        ...
        question_frame = ttk.LabelFrame(parent, text="Question", padding="15")
        question_frame.grid(row=2, column=0, sticky=(tk.W, tk.E, tk.N, tk.S), pady=(0, 10))
        question_frame.columnconfigure(0, weight=1)
        
        self.question_text = scrolledtext.ScrolledText(
            question_frame, wrap=tk.WORD, height=5, 
    ...
    def create_options_frame(self, parent):
        """Create answer options area"""
        self.options_frame = ttk.LabelFrame(parent, text="Answer Options", padding="15")
        self.options_frame.grid(row=3, column=0, sticky=(tk.W, tk.E), pady=(0, 10))
        self.options_frame.columnconfigure(0, weight=1)
        self.option_widgets: List[ttk.Widget] = []
    
    def create_explanation_frame(self, parent):
        """Create explanation area"""
        self.explanation_frame = ttk.LabelFrame(parent, text="Explanation", padding="15")
        ...
        self.explanation_text = scrolledtext.ScrolledText(
            self.explanation_frame, wrap=tk.WORD, height=4,
    ...
    def create_navigation_frame(self, parent):
        ...
        self.prev_button = ttk.Button(nav_frame, text="← Previous", 
                                      command=self.prev_question, width=12)
        ...
        self.next_button = ttk.Button(nav_frame, text="Next →", 
                                      command=self.next_question, width=12)
    ...
    def display_question(self):
        ...
        answered_count = sum(1 for q in self.questions if q.is_answered())
        self.progress_label.config(text=f"Question {q.number} of {len(self.questions)}")
        self.answered_label.config(text=f"Answered: {answered_count}/{len(self.questions)}")
        self.progress_bar['value'] = answered_count
        ...
        if q.is_multi_select:
            question_display += "\n\n📋 (Select ALL that apply - check all correct answers)"
        ...
        if q.is_multi_select:
            self.create_multiselect_options(q)
        else:
            self.create_singleselect_options(q)
        ...
        if q.is_answered() or self.exam_submitted:
            self.show_explanation()
        else:
            self.explanation_frame.grid_remove()
    
    def create_singleselect_options(self, q: Question):
        """Create radio button options"""
        self.single_var = tk.StringVar()
        
        if q.user_answers:
            self.single_var.set(list(q.user_answers)[0])
        ...
        for i, (key, value) in enumerate(sorted(q.options.items())):
            ...
            rb.grid(row=i, column=0, sticky=tk.W, pady=4, padx=10)
            self.option_widgets.append(rb)
            self.answer_vars[key] = self.single_var
    
    def create_multiselect_options(self, q: Question):
        ...
        for i, (key, value) in enumerate(sorted(q.options.items())):
            ...
            cb.grid(row=i, column=0, sticky=tk.W, pady=4, padx=10)
    ...
    def submit_answer(self):
        ...
        if q.is_multi_select:
            q.user_answers = {k for k, v in self.answer_vars.items() if v.get()}
        else:
            selected = self.single_var.get()
            if selected:
        ...
        if q.is_correct():
            messagebox.showinfo("✓ Correct!", "Great job! Your answer is correct.", parent=self.root)
        else:
    ...
    def finish_exam(self, auto_submit: bool = False):
        """Complete the exam and show comprehensive results"""
        self.stop_timer()
        ...
        if unanswered and not auto_submit and not self.exam_submitted:
            unanswered_str = ", ".join(map(str, unanswered[:15]))
            if len(unanswered) > 15:
                unanswered_str += f"... and {len(unanswered) - 15} more"
            
            result = messagebox.askyesno(
                "Unanswered Questions",
                f"You have {len(unanswered)} unanswered question(s):\n\n"
                f"Questions: {unanswered_str}\n\n"
        ...
        # Calculate domain scores with question tracking
        domain_scores = {}
        domain_names = {
        ...
        self.show_results_dialog(
            correct_count, total_count, percentage, time_used,
    ...
    def show_results_dialog(self, correct: int, total: int, percentage: float,
        ...
        unanswered_count = sum(1 for q in self.questions if not q.is_answered())
...
╚═══════════════════════════════════════════════════════════════╝
    ...
    ════════════════════════════════════════════════════
       ...
       ✓ Correct:          {correct}
       ✗ Incorrect:        {total - correct - unanswered_count}
...
"""
        ...
        def export_results():
            ...
            if filename:
                with open(filename, 'w') as f:
                    f.write("SPLUNK CORE USER PRACTICE EXAM RESULTS\n")
                    f.write("=" * 60 + "\n\n")
    ...
    def on_closing(self):
        """Handle window close"""
        if not self.exam_submitted and self.exam_started:
            result = messagebox.askyesno(
                "Exit Exam",
